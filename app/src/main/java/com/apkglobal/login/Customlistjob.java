...
public class Customlistjob extends ArrayAdapter<String> {
    ...
    public Customlistjob(Activity context, String[] comapany_names, String[] comapany_emails, String[] experiences, String [] salarys,String [] jobprofiles,String [] locations) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.datalistjob, null, true);
