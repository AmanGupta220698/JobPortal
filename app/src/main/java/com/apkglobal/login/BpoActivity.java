...
public class BpoActivity extends AppCompatActivity {

    ListView joblistView;
    SwipeRefreshLayout swipeRefreshLayout;
    String url="http://searchkero.com/job_mitrc/fbpofetch.php";
    TextView text_jobs;
    ImageView img_check;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bpo);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("BPO Jobs");


        joblistView=findViewById(R.id.bpolistview);
        ...
        StringRequest stringRequest = new StringRequest(url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(BpoActivity.this,error.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });
    ...
    public void jobclick(View view) {
        ...
        Intent profile=new Intent(BpoActivity.this,ResumeActivity.class);
